public class Main
{
    public static void main(String[] args )
    {
        ...
        double doubleOperandB = 6.32;
        double doubleSum = 5.35;
        double doubleProduct = 2.44;
        double doubleDifference = 4.55;
        double doubleQuotient = 8.99;
